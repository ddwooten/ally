...
# 
# This file has been mofidied from its original version to be compliant with 
# Python3 as it was originally written in Python2. Otherwise the integerity of
# the file has been preserved - including its original documentation.
